...
> AI-generated note: Some summaries and documents in this repo were generated by AI and may contain mistakes.
...
AI_NOTE = "> AI-generated note: This summary was generated by AI and may contain mistakes."
...
for dt, d in subdirs_with_dates:
    ...
    if summary_file.exists():
        ...
        try:
            ...
            if summary:
                summary_file.write_text(AI_NOTE + '\n\n' + summary + '\n')
        except Exception:
            summary = ''

    if summary.startswith(AI_NOTE):
        summary = summary[len(AI_NOTE):].strip()
